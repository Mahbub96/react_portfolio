...
const SEOHead = ({ 
  ...
  return (
    <>
      ...
      <meta name="image:alt" content={`${name} - ${jobTitle} Professional Headshot`} />
      ...
      <meta name="image:caption" content={`${name} - ${jobTitle} Professional Headshot`} />
      ...
      <link rel="preload" as="image" href={`${url}/assets/img/profile-og.png`} />
