 ...
 * Renders chip text where hovering over the chip triggers Simple Harmonic Motion (SHM)
 * rotational physics across every character in a smooth coordinated wave (not separately).
 */
